...
export const startLocationShare = async (req, res) => {
    try {
        const { recipientName, recipientPhone } = startShareSchema.parse(req.body);
        const userId = req.userId;
        const locationShare = prisma.locationShare;
        if (!locationShare) {
...
export const stopLocationShare = async (req, res) => {
    try {
...
export const getActiveShares = async (req, res) => {
    try {
        const userId = req.userId;
        const locationShare = prisma.locationShare;
        if (!locationShare) {
